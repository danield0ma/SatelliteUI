  ...
  for (let i = 0; i < count; i++) {
    ...
    switch (messageType) {
      case 1: // Power message
        payload = [
          randomInt(0, 255), // Solar voltage 1
          randomInt(0, 255), // Solar voltage 2
          randomInt(0, 255), // Solar voltage 3
          randomInt(150, 200), // Battery voltage
        ]
        break
      case 2: // Temperature message
        payload = [
          randomInt(0, 255), // Temperature 1
          randomInt(0, 255), // Temperature 2
          randomInt(0, 255), // Temperature 3
        ]
        break
      case 3: // Current message
        payload = [
          randomInt(0, 100), // Current 1
          randomInt(0, 100), // Current 2
          randomInt(0, 100), // Current 3
          randomInt(0, 100), // Current 4
        ]
        break
      case 4: // Status message
        payload = [
          randomInt(0, 1), // System status
          randomInt(0, 3), // Operation mode
          randomInt(0, 255), // Error code
        ]
        break
    }
